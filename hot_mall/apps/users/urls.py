...
urlpatterns = [
    ...
    # 人脸注册
    path('face/register/', views.FaceRegisterView.as_view(), name='face_register'),
    # 人脸登录
    path('face/login/', views.FaceLoginView.as_view(), name='face_login'),
    # 会员管理
    path('members/', views.MemberListView.as_view(), name='member_list'),
    path('members/api/', views.MemberListAPIView.as_view(), name='member_api'),
    path('members/edit/<int:pk>/', views.MemberUpdateView.as_view(), name='member_edit'),
    path('members/reset-password/<int:user_id>/', views.MemberResetPasswordView.as_view(), name='member_reset_password'),
